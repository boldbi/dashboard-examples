...
- `Snapshot.zip` : This documentation file provides an overview of the dashboard, including its key metrics, like highest number of medals in sports and medals won by top countries, and the widget images.
